...
public class MealServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Meal meal = new Meal(id.isEmpty() ? null : Integer.valueOf(id),
                ...
                Integer.valueOf(request.getParameter("calories")), userId.isEmpty() ? null : Integer.valueOf(userId));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action == null ? "all" : action) {
            ...
            default:
                ...
                LocalTime fromTime = parseTime(request.getParameter("fromTime"));
                LocalTime toTime = parseTime(request.getParameter("toTime"));
                request.setAttribute("meals", mealRestController.getFilteredAll(fromDate, toDate, fromTime, toTime));
