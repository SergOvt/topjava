...
@NamedQueries({
        @NamedQuery(name = Meal.UPDATE, query = "UPDATE Meal m SET m.dateTime=:date_time, m.description=:description, m.calories=:calories " +
        ...
        @NamedQuery(name = Meal.BETWEEN, query = "SELECT m FROM Meal m WHERE m.dateTime BETWEEN ?1 AND ?2 AND m.user.id = ?3 ORDER BY m.dateTime DESC"),
})
@Entity
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String UPDATE = "Update.get";
