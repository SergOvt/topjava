...
public class MealsUtil {
    public static void main(String[] args) {
        ...
        MealDao mealDao = new MealDaoVirtual();

        List<MealWithExceed> mealsWithExceeded = getFilteredWithExceeded(mealDao.getAll(), LocalTime.of(7, 0), LocalTime.of(12, 0), 1000);
